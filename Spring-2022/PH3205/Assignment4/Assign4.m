%----------------------------------------------------------------
  ...
  %w = L/50;
  a = 3*w;
 % U = -40*(heaviside(x+w-a) - heaviside(x-w-a)  + heaviside(x+w+a) - heaviside(x-w+a)  + heaviside(x+w-3*a) -heaviside(x-w-3*a))%+ x.^6 -0.5.*x.^3+sin(100.*x);
  U = -40*(heaviside(x+w/2) - heaviside(x-w/2)  + heaviside(x+w/2+a) - heaviside(x-w/2+a)  + heaviside(x+w/2-a) -heaviside(x-w/2-a))%+ x.^6 -0.5.*x.^3+sin(100.*x);
